...
sp['education'].replace(['some high school'], 14, inplace=True)
sp['education'].replace(['high school'], 8, inplace=True)
sp['education'].replace(['some college'], 9, inplace=True)
sp['lunch'].replace(['standard'], 10, inplace=True)
sp['lunch'].replace(['free/reduced'], 11, inplace=True)
sp['test_preparation_course'].replace(['none'], 12, inplace=True)
sp['test_preparation_course'].replace(['completed'], 13, inplace=True)
